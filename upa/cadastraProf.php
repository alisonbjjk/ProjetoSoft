...
<body>
    ...
    <div class="form">
        <div class="form_conteudo">
            ...
            <form id="form_recep" name="form_recep" action="../Controller/processCadProf.php" method="post" onSubmit="return(valida(this))">
                ...
                <span class="lbl2"><span class="lbl_interno">Email</span></span>
                <input id="email" class="texto" type="email" name="email" />
